...
ID3D11InputLayout *g_pLayout = nullptr; // pointer to the input layout
...
HRESULT CreateGraphicsResources(HWND hWnd)
{
    ...
    {
        // create a struct to hold information of the swap chain
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    hWnd = CreateWindowEx(0,
                          ...
                          100,                             // x-pos of the window
                          100,                             // y-pos of the window
